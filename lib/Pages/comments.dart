...
import 'package:admin1/Bloc/commentbloc.dart';
import 'package:admin1/Config/config.dart';
import 'package:admin1/Models/comment.dart';
                ...
                children: <Widget>[
                  ...
                  FlatButton(
                    ...
                    onPressed: () async {
                      await context
                          .read<CommentBloc>()
                          .deleteComment(widget.timestamp, d.uid, d.timestamp,
                              widget.collectionName)
                          .then((value) {
                        if (widget.collectionName == 'places') {
                          context
                              .read<CommentBloc>()
                              .decreaseCommentsCount(widget.timestamp);
                        }
    ...
    if (ab.userType == 'tester') {
      ...
      if (value.isEmpty) {
        ...
        await context
            .read<CommentBloc>()
            .saveNewComment(
                widget.timestamp, textFieldCtrl.text, widget.collectionName)
            .then((value) {
          if (widget.collectionName == 'places') {
            context
                .read<CommentBloc>()
                .increaseCommmentsCount(widget.timestamp);
          }
